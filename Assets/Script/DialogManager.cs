...
public class DialogManager : MonoBehaviour
{
    ...
    IEnumerator GuideDialogCoroutine()
    {
        ...
        while (true)
        {
            tuple = dialogData.GetGuideDialogData(id, index);    // 대화 데이터 가져오기
    ...
    IEnumerator PermissionDialogCoroutine()
    {
        ...
        while (true)
        {
            tuple = dialogData.GetPermissionDialogData(id, index);    // 대화 데이터 가져오기
    ...
    IEnumerator RefuseDialogCoroutine()
    {
        ...
        while (true)
        {
            tuple = dialogData.GetRefuseDialogData(id, index);    // 대화 데이터 가져오기
